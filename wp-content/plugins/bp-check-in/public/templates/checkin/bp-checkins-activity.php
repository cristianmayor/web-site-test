...
if ( $bpchk_fav_places ) {
	?>
	<h2 class="screen-heading view-profile-screen"><?php esc_html_e( 'My Check-ins', 'bp-checkins' ); ?></h2>
	<div id="accordion" class="bpchk-fav-loc-map-container">
		...
		foreach ( $bpchk_fav_places as $key => $fav_places ) {
			...
			?>
			<h3 class="checkin-accordion-title"><?php echo esc_attr( $fav_places['place'] ); ?>
			...
			<div class="checkin-accordion-panel">
