...
@media (max-width: 767px) {
	...
	.notice.bp-group-reviews-notice .bp-group-reviews-notice-inner .no-thanks {
		...
		public function set_no_bug() {
			...
			if ( ! isset( $_GET['_wpnonce'] ) || ( ! wp_verify_nonce( $_GET['_wpnonce'], 'bp-group-reviews-feedback-nounce' ) || ! is_admin() || ! isset( $_GET[ $this->nobug_option ] ) || ! current_user_can( 'manage_options' ) ) ) {
				return;
			}
