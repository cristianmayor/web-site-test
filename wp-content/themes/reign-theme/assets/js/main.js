...
( function ( $ ) {
    ...
    window.Reign = {
        ...
        Slider: function ( ) {
            ...
            $( 'aside #members-carousel-list, aside #members-carousel-list-widget, aside #groups-carousel-list, aside #groups-carousel-list-widget' ).not('.slick-initialized').slick( {
                slidesToShow: 1                
            } );
        ...
        activityModal: function () {
            if ( 'on' != wp_main_param.activity_post_popup ) {
                $( '.activity-update-form:not(.modal-popup):not(.bp-activity-edit) #whats-new' ).on( 'focus', function () {
        ...
        bpTabMenu: function () {
            ...
            $( '.rg-nouveau-sidebar-menu .main-navs:not(.vertical) ul' ).BuddyPressMenu( 90 );
...
jQuery( document ).ready( function () {
    if ( !( jQuery( '.bp-nouveau .wbtm-item-buttons-wrapper #item-buttons button' ).length ) ) {
        ...
        jQuery( '.bp-nouveau .wbtm-cover-header-type-3 .wbtm-cover-extra-info-section' ).css("padding-bottom", 0);
    }
} );
