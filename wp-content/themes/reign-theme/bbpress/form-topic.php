...
if ( !bbp_is_single_forum() ) :
			...
			<form id="new-post" name="new-post" method="post" class="rg-bbp-form">
				...
				<fieldset class="bbp-form">
					...
					<div>
						...
						<p>
							<label for="bbp_topic_title"><?php printf( esc_html__( 'Topic Title (Maximum Length: %d):', 'reign' ), bbp_get_title_max_length() ); ?></label>
						...
						<?php if ( bbp_allow_revisions() && bbp_is_topic_edit() ) : ?>
							...
							<fieldset class="bbp-form">
								...
								<div>
									<label for="bbp_topic_edit_reason"><?php printf( esc_html__( 'Optional reason for editing:', 'reign' ), bbp_get_current_user_name() ); ?></label>
	...
	<?php elseif ( bbp_is_forum_closed() ) : ?>
		...
		<div id="forum-closed-<?php bbp_forum_id(); ?>" class="bbp-forum-closed">
			<div class="bbp-template-notice">
				<ul>
					<li><?php printf( esc_html__( 'The forum &#8216;%s&#8217; is closed to new topics and replies.', 'reign' ), bbp_get_forum_title() ); ?></li>
				</ul>
			</div>
		</div>
