...
if ( ! class_exists( 'Reign_Theme_Structure' ) ) :
	...
	class Reign_Theme_Structure {
		...
		private function init_hooks() {
			...
			/**
			 * Render bbpress post title.
			 */
			add_action( 'rtm_post_begins', array( $this, 'render_bbpress_post_title' ) );
		}
...
//		}
		...
		public function render_bbpress_post_title() {
		...
		public function render_page_header() {
			...
			if ( is_singular() ) {
				...
				$cpt_single_header_enable = get_theme_mod( 'reign_' . $post_type . '_single_header_enable' );
				...
				$search_header_enable = get_theme_mod( 'reign_search_header_enable' );
				...
				$default_single_header_enable    = get_theme_mod( 'reign_cpt_default_sub_header_switch', false );
				$archive_post_type_header_enable = get_theme_mod( 'reign_' . $post_type . '_archive_header_enable' );
				if ( false === $default_single_header_enable ) {
