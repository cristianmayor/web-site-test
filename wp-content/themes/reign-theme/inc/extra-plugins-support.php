...
if ( empty( get_option( 'elementor_disable_color_schemes' ) ) ) {
	// add_action( 'wp_head', 'reign_elementor_color_scheme_css' );
}

function reign_elementor_color_scheme_css() {
...
if ( isset( $diable_typo ) && ( $diable_typo != 'yes' ) ) {
	// add_action( 'wp_head', 'reign_elementor_font_scheme_css' );
}

function reign_elementor_font_scheme_css() {
...
function my_wc_cart_count() {
	...
	if ( class_exists( 'WooCommerce' ) ) {
		...
		<div class="woo-cart-wrapper">
			<a class="rg-icon-wrap woo-cart-wrap" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'reign' ); ?>">
	...
	if ( class_exists( 'Easy_Digital_Downloads' ) ) {
		...
		<div class="edd-cart-wrapper">
			<a class="rg-icon-wrap edd-cart-wrap" href="<?php echo edd_get_checkout_uri(); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'reign' ); ?>">
				<span class="fa fa-shopping-cart"></span>
...
function reign_woo_mini_cart_render() {
	if ( class_exists( 'WooCommerce' ) ) {
		...
		<div id="rg-mobile-icon-toggle" data-id="rg-slidebar-toggle">
			<a class="rg-icon-wrap woo-cart-wrap" href="#" title="<?php esc_attr_e( 'View your shopping cart', 'reign' ); ?>">
				<span class="fa fa-shopping-cart"></span>
				<span class="cart-contents-count rg-count"><?php echo esc_html( $count ); ?></span>
			</a>
		</div>
...
add_action( 'reign_before_page', 'reign_add_canvas_for_toggle_slidebars' );
...
add_action( 'reign_begin_masthead', 'reign_desktop_enable_first_panel' );
...
function reign_edd_download_cart_render() {
	if ( class_exists( 'Easy_Digital_Downloads' ) ) {
		...
		?>
		<div id="rg-mobile-icon-toggle" data-id="rg-slidebar-toggle">
			<a class="rg-icon-wrap edd-cart-wrap" href="#" title="<?php esc_attr_e( 'View your shopping cart', 'reign' ); ?>">
				<span class="fa fa-shopping-cart"></span>
				<span class="cart-contents-count rg-count edd-cart-quantity"><?php echo esc_html( $count ); ?></span>
			</a>
		</div>
...
// MediaPress Customizations.
if ( function_exists( 'mpp_activity_dropzone' ) ) {
	remove_action( 'bp_after_activity_post_form', 'mpp_activity_dropzone' );
	add_action( 'bp_activity_post_media', 'mpp_activity_dropzone' );
}
