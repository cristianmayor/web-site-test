		...
		if( !$reign_header_header_type ) {
			...
			if( 'v4' === $header_version ) {
				...
				<style type="text/css">
					...
					body.reign-header-v4 header#masthead .reign-fallback-header.version-four .mega-menu-wrap ul.mega-menu.max-mega-menu.mega-menu-horizontal > li.mega-menu-item > a.mega-menu-link {	
                                                font-family: <?php echo isset( $reign_header_main_menu_font['font-family'] ) ? $reign_header_main_menu_font['font-family'] :''; ?> !important;
                                                font-weight: <?php echo isset( $reign_header_main_menu_font['font-weight'] ) ? $reign_header_main_menu_font['font-weight'] :''; ?> !important;
                                                font-size: <?php echo isset( $reign_header_main_menu_font['font-size'] ) ? $reign_header_main_menu_font['font-size'] :''; ?> !important;
                                                letter-spacing: <?php echo isset( $reign_header_main_menu_font['letter-spacing'] ) ? $reign_header_main_menu_font['letter-spacing'] :''; ?> !important;
                                                color: <?php echo isset( $reign_header_main_menu_font['color'] ) ? $reign_header_main_menu_font['color'] :''; ?> !important;
                                                text-transform: <?php echo isset( $reign_header_main_menu_font['text-transform'] ) ? $reign_header_main_menu_font['text-transform'] :''; ?> !important;
                                                text-align: <?php echo isset( $reign_header_main_menu_font['text-align'] ) ? $reign_header_main_menu_font['text-align'] :''; ?> !important;
                                                font-weight: <?php echo isset( $reign_header_main_menu_font['font-weight'] ) ? $reign_header_main_menu_font['font-weight'] :''; ?> !important;
                                                font-style: <?php echo isset( $reign_header_main_menu_font['font-style'] ) ? $reign_header_main_menu_font['font-style'] :''; ?> !important;
					}
					@media (max-width: 767px) {
						...
						body.reign-header-v4 header#masthead .reign-fallback-header.version-four .mega-menu-wrap ul.mega-menu.max-mega-menu.mega-menu-horizontal > li.mega-menu-item > a.mega-menu-link {
							font-family: <?php echo isset( $reign_header_mobile_menu_font['font-family'] ) ? $reign_header_mobile_menu_font['font-family'] :''; ?> !important;
							font-variant: <?php echo isset( $reign_header_mobile_menu_font['font-variant'] ) ? $reign_header_mobile_menu_font['font-variant'] :''; ?> !important;
							font-size: <?php echo isset( $reign_header_mobile_menu_font['font-size'] ) ? $reign_header_mobile_menu_font['font-size'] :''; ?> !important;
							letter-spacing: <?php echo isset( $reign_header_mobile_menu_font['letter-spacing'] ) ? $reign_header_mobile_menu_font['letter-spacing'] :''; ?> !important;
							color: <?php echo isset( $reign_header_mobile_menu_font['color'] ) ? $reign_header_mobile_menu_font['color'] :''; ?> !important;
							text-transform: <?php echo isset( $reign_header_mobile_menu_font['text-transform'] ) ? $reign_header_mobile_menu_font['text-transform'] :''; ?> !important;
							text-align: <?php echo isset( $reign_header_mobile_menu_font['text-align'] ) ? $reign_header_mobile_menu_font['text-align'] :''; ?> !important;
                                                        font-weight: <?php echo isset( $reign_header_mobile_menu_font['font-weight'] ) ? $reign_header_mobile_menu_font['font-weight'] :''; ?> !important;
                                                        font-style: <?php echo isset( $reign_header_mobile_menu_font['font-style'] ) ? $reign_header_mobile_menu_font['font-style'] :''; ?> !important;
						}
					}
				</style>
				<?php
