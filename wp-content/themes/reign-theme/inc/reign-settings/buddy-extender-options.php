...
if (!class_exists('Reign_Buddy_Extender_Options')) :
    ...
    class Reign_Buddy_Extender_Options {
                ...
                <tr>
                    <td class="rtm-left-side">
                        <div class="rtm-tooltip-wrap">
                            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/question.png'); ?>" class="rtm-tooltip-image" alt="<?php esc_attr_e('tooltip-image', 'reign'); ?>" />
                            <label class="rtm-tooltip-label">
                                <?php esc_html_e('Member Header', 'reign'); ?>
                            </label>
                        </div>
                        <div class="rtm-tooltiptext">
                ...
                <tr>
                    <td class="rtm-left-side">
                        <div class="rtm-tooltip-wrap">
                            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/question.png'); ?>" class="rtm-tooltip-image" alt="<?php esc_attr_e('tooltip-image', 'reign'); ?>" />
                            <label class="rtm-tooltip-label">
                                <?php esc_html_e('Group Header', 'reign'); ?>
                            </label>
                        </div>
                        <div class="rtm-tooltiptext">
                ...
                <tr>
                    <td class="rtm-left-side">
                        <div class="rtm-tooltip-wrap">
                            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/question.png'); ?>" class="rtm-tooltip-image" alt="<?php esc_attr_e('tooltip-image', 'reign'); ?>" />
                            <label class="rtm-tooltip-label">
                                <?php esc_html_e('Member Directory', 'reign'); ?>
                            </label>
                        </div>
                        <div class="rtm-tooltiptext">
                ...
                <tr>    
                    <td class="rtm-left-side">
                        <div class="rtm-tooltip-wrap">
                            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/question.png'); ?>" class="rtm-tooltip-image" alt="<?php esc_attr_e('tooltip-image', 'reign'); ?>" />
                            <label class="rtm-tooltip-label">
                                <?php esc_html_e('Group Directory', 'reign'); ?>
                            </label>
                        </div>
                        <div class="rtm-tooltiptext">
            ...
            <table class="form-table">
                <tr>
                    <td class="rtm-left-side">
                        <div class="rtm-tooltip-wrap">
                            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/question.png'); ?>" class="rtm-tooltip-image" alt="<?php esc_attr_e('tooltip-image', 'reign'); ?>" />
                            <label for="avatar_thumb_size_select" class="rtm-tooltip-label">
                ...
                <tr>
                    <td class="rtm-left-side">
                        <div class="rtm-tooltip-wrap">
                            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/question.png'); ?>" class="rtm-tooltip-image" alt="<?php esc_attr_e('tooltip-image', 'reign'); ?>" />
                            <label for="avatar_full_size_select" class="rtm-tooltip-label">
                ...
                <tr>
                    <td class="rtm-left-side">
                        <div class="rtm-tooltip-wrap">
                            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/question.png'); ?>" class="rtm-tooltip-image" alt="<?php esc_attr_e('tooltip-image', 'reign'); ?>" />
                            <label for="avatar_max_size_select" class="rtm-tooltip-label">
            ...
            <table class="form-table">
                ...
                <?php if (class_exists('BP_XProfile_Group')): ?>
                    <tr>
                        <td class="rtm-left-side">
                            <div class="rtm-tooltip-wrap">
                                <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/question.png'); ?>" class="rtm-tooltip-image" alt="<?php esc_attr_e('tooltip-image', 'reign'); ?>" />
                                <label for="selected_xprofile_field" class="rtm-tooltip-label">
                ...
                <tr>
                    <td class="rtm-left-side">
                        <div class="rtm-tooltip-wrap">
                            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/question.png'); ?>" class="rtm-tooltip-image" alt="<?php esc_attr_e('tooltip-image', 'reign'); ?>" />
                            <label for="activity_popup_checkbox" class="rtm-tooltip-label">
        ...
        public function render_theme_options_for_group_cover_image() {
            ...
            echo '<div class="rtm-tooltip-wrap">';
            echo '<img src="' . esc_url(get_template_directory_uri() . '/assets/img/question.png') . '" class="rtm-tooltip-image" alt="tooltip-images" />';
            echo '<label class="rtm-tooltip-label">' . __('Select Image Size', 'reign') . '</label>';
            echo '</div>';
            ?>
            <div class="rtm-tooltiptext">
