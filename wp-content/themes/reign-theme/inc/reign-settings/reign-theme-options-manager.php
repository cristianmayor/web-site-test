					...
					<div class="wbtm_social_link_info_box">
						<div class="img_section">
							<?php if ( class_exists( 'PeepSo' ) ) { ?>
								<input class="reign_default_cover_image_url" type="hidden" name="reign_peepsoextender[wbtm_social_links][{{unique_key}}][img_url]" value="<?php
							...
							<?php } ?>
							<img class="reign_default_cover_image" src="<?php
							if ( isset( $social_link[ 'img_url' ] ) ) {
								echo $social_link[ 'img_url' ];
							}
							?>" style="display: none;" />
