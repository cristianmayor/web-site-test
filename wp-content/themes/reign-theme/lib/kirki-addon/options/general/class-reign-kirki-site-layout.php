	...
	class Reign_Kirki_Site_Layout {
		...
		public function add_fields( $fields ) {
			...
			$fields[] = array(
				...
				'label'			 => esc_attr__( 'Site Loader', 'reign' ),
				'description'	 => esc_attr__( 'Show loader before loading content.', 'reign' ),
			...
			$fields[] = array(
				...
				'description'	 => esc_attr__( 'Select site layout.', 'reign' ),
				'section'		 => 'reign_site_layout_options',
				'default'		 => 'full_width',
				'priority'		 => 10,
				'choices'		 => array(
			...
			$fields[] = array(
				...
				'description'	 => esc_attr__( 'Set the width of the site container ( px or % ). Default is 1170px.', 'reign' ),
				'section'		 => 'reign_site_layout_options',
				'default'		 => '1170px',
				'priority'		 => 10,
				'transport'		 => 'auto',
			...
			$fields[] = array(
				...
				'output'		 => array(
					array(
						'element'	 => '.site-content .widget-area, .reign-both_sidebar aside#reign-sidebar-right, .reign-both_sidebar aside#reign-sidebar-left',
						'function'	 => 'css',
						'property'	 => 'max-width',
					),
				),
