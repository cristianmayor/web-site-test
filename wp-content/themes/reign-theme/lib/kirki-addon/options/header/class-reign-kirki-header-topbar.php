	...
	class Reign_Kirki_Header_Topbar {
		...
		public function add_fields( $fields ) {
			...
			$fields[] = array(
				...
				'description'	 => esc_attr__( 'Enable or Disable topbar.', 'reign' ),
			...
			$fields_on_hold[]	 = array(
				...
				'label'				 => esc_attr__( 'Disable Topbar On Mobile', 'reign' ),
				'description'		 => esc_attr__( 'Disable topbar on mobile view.', 'reign' ),
				'section'			 => 'reign_header_topbar',
				'default'			 => 0,
				'priority'			 => 10,
				'choices'			 => array(
