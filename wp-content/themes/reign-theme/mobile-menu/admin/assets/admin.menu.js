...
jQuery( document ).ready( function($){
	...
	$( '#menu-management' ).on( 'hover, touchEnd, MSPointerUp, pointerup' , '.menu-item:not(.shiftnav-processed)' , function(e){
		...
		$(this).find( '.item-title' ).append( '<span class="shiftnav-settings-toggle" data-shift-toggle="' + $(this).attr('id') + '"><i class="fa fa-gear"></i> Reign Icon <span class="shiftnav-unsaved-alert"><i class="fa fa-warning"></i> <span class="shiftnav-unsaved-alert-message">Unsaved</span></span></span>' );
