...
function shiftnav_settings_panel_fields_pro( $fields = array() ) {
	...
	$fields[ $main ][ 1055 ] = array(
		'name' 				 => 'display_user_avatar',
		'label' 			 => __( 'Display User Avatar', 'reign' ),
		'desc' 				 => __( 'Display the User avatar in the menu panel', 'reign' ),
		'type' 				 => 'checkbox',
		'default' 			 => '',
		'customizer'		 => true,
		'customizer_section' => 'content',
	...
	$fields[ $main ][ 1070 ] = array(
		...
		'type'				 => 'textarea',
		'default'			 => '<p><i class="fa fa-mobile" aria-hidden="true"></i><a href="tel:+18475555555"> 1-800-FAKE-NUM</a></p>',
		'sanitize_callback'	 => 'shiftnav_allow_html',
		'customizer'		 => true,
		'customizer_section' => 'content',
	);
...
function reign_mobile_header_default_values() {
	...
	if ( class_exists( 'PeepSo' ) ) {
		...
		if ( !isset( $panel_options[ 'toggle_content_right' ] ) || $update_right_edge ) {
			$panel_options[ 'toggle_content_right' ] = '[shiftnav_toggle target="shiftnav-second" class="shiftnav-toggle-button" icon="peepso-user-menu"][/shiftnav_toggle]';
		}
	}
