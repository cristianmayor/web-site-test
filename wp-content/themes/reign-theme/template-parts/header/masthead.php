			...
			<div class="header-right no-gutter wb-grid-flex wb-grid-center">
				...
				if ( is_user_logged_in() ) {
					...
					<div class="rg-icon-wrap rg-login-btn-wrap">
						<a href="<?php echo $login_page_url; ?>" class="btn-login button" title="<?php esc_attr_e( 'Login', 'reign' ); ?>"><?php esc_html_e( 'Login', 'reign' ); ?><span class="fa fa-sign-in"></span></a>
					</div><?php
					if ( get_option( 'users_can_register' ) ) {
						?>
						<span class="sep">|</span>
						<div class="rg-icon-wrap rg-register-btn-wrap">
							<a href="<?php echo $registration_page_url; ?>" class="btn-register button" title="<?php esc_attr_e( 'Register', 'reign' ); ?>"><?php esc_html_e( 'Register', 'reign' ); ?><span class="fa fa-address-book-o"></span></a>
						</div>
						<?php
					}
				}
