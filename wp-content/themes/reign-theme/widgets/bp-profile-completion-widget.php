...
class BP_Reign_Profile_Completion_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array(
			...
			'description' => __( 'Show Logged in user Profile Completion Progress.', 'reign-theme' ),
		);

		/* Set up the widget. */
		parent::__construct(
			false,
			__( '(BuddyPress) Profile Completion', 'reign-theme' ),
			$widget_ops
		);
	}
	...
	function widget( $args, $instance ) {
		...
		$progress_label = sprintf( __( '%s Complete', 'reign-theme' ), $user_progress['completion_percentage'] . '%' );
		?>
				...
				<div class="wb-bp-progress-text">
					<div class="wb-bp-user-avatar-wrap">
						...
						<div class="wb-bp-progress-label">
							...
							<span><?php echo esc_html__( 'Complete', 'reign-theme' ); ?></span>
						</div>
					</div>
				</div>
	...
	function get_user_profile_progress( $group_ids, $photo_types ) {
		...
		$progress_details['groups'][] = array(
			'group_name'             => __( 'Profile Fields', 'reign-theme' ),
